...
export default function Footer() {
  return (
    <>
      <div className="py-10 flex flex-col md:flex-row  justify-between space-y-14 md:space-y-0 md:items-center">
        <div className="space-y-5">
          ...
          <p className=" max-w-xs">
            ...
            unde minima a. Eligendi vitae, accusamus inventore ea expedita,
            nihil ratione quos praesentium, omnis odio officiis? Officia
            officiis expedita laboriosam facilis!
          </p>
      ...
      <div className="text-center capitalize text-darkBlue py-10">
        <p>&copy; 2021 all rights reserved @tansi jones</p>
      </div>
    </>
  );
}
